<script type="module">
            ...
            const submitForm = async () => {
                ...
                try {
                    ...
                    if (response?.status === 422) {
                        ...
                        errorMessage.value = response?.data?.message || '送信に失敗しました。時間をおいて再度お試しください。';
                    }
                } finally {
    ...
    createApp(App).mount('#my-contact-app');
</script>

<div id="my-contact-app" style="display: none;">
    <div v-if="!isSent">
    ...
    <div v-else class="bg-green-100 text-green-700 p-4 rounded mb-4">
        送信が完了しました。
    </div>
</div>